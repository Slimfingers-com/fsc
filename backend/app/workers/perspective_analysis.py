...
class PerspectiveAnalysisWorker:
    def __init__(
        self,
        *,
    ...
    def run_forever(self) -> None:
        logger.info(
            "Perspective analysis worker started"
        )
        ...
        while not self.stop_event.is_set():
            try:
                ...
                logger.exception(
                    "Unexpected perspective analysis worker failure"
                )
        ...
        logger.info(
            "Perspective analysis worker stopped"
        )
    ...
    def install_signal_handlers(
        ...
        def handle_signal(
            ...
            logger.info(
                "Received signal %s; "
                "stopping perspective analysis worker",
                signum,
            )
            self.request_stop()
