...
class ClaimRelationWorker:
    ...
    def run_once(self):
        ...
        logger.info(
            "Claim relation analysis completed: "
    ...
    def run_forever(self) -> None:
        ...
        while not self.stop_event.is_set():
            try:
                ...
                logger.exception(
                    "Unexpected claim relation worker failure"
                )
    ...
    def install_signal_handlers(
        ...
        def handle_signal(
            ...
            logger.info(
                "Received signal %s; "
                "stopping claim relation worker",
                signum,
            )
            self.request_stop()
