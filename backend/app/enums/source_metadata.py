...
class SourceMetricKind(StrEnum):
    ...
    RADIO_DAILY_LISTENERS = "radio_daily_listeners"
    RADIO_HOURLY_LISTENERS = "radio_hourly_listeners"
    RADIO_MARKET_SHARE = "radio_market_share"
    TV_VIEWERS = "tv_viewers"
    TV_DAILY_REACH = "tv_daily_reach"
    TV_MARKET_SHARE = "tv_market_share"
